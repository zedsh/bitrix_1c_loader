 ...
 */
class BitrixSaleExchangeGoldCow
{
    ...
    {
        echo "INIT\n";
        $params = $this->params + ['type' => $this->type, 'mode' => 'init'];
    ...
    {
        echo "FILE\n";
        $params = $this->params + ['type' => $this->type, 'mode' => 'file', 'filename' => $name];
    ...
    {
        echo "IMPORT\n";
        $params = $this->params + ['type' => $this->type, 'mode' => 'import', 'filename' => $name];
        while (true) {
            $response = $this->client->request('GET',
                self::EXCHANGE_SCRIPT, [
                    'query' => $params,
